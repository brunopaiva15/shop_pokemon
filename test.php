...
<body class="bg-gray-100 flex flex-col items-center justify-center min-h-screen space-y-6 px-4">
    ...
    <div id="captureZone"
        class="w-full max-w-[640px] aspect-square relative bg-white shadow-lg overflow-hidden">
        ...
        <div class="absolute inset-0 flex items-center justify-center z-10 px-4">
            <div class="bg-white/80 backdrop-blur-md rounded-lg px-6 py-8 text-center shadow-md max-w-sm w-full">
                <div class="flex items-center justify-center gap-3 mb-3">
                    <img src="assets/images/logo_noir.png" alt="Logo BDPokéCards" class="h-10 w-10 object-contain">
                    <h1 class="text-3xl sm:text-4xl font-extrabold text-gray-800">BDPokéCards</h1>
                </div>
                <p class="text-base text-gray-600 mb-5">Ta nouvelle boutique en ligne Pokémon TCG ouvre officiellement</p>
